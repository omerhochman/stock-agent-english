...
def call_financial_data_tool(
    ...
    Args:
        ...
        data_source_method: Data source method to call
    ...
    Returns:
        Markdown format string containing result or error message
    """
...
def call_macro_data_tool(
    ...
    **kwargs  # For additional parameters, e.g., year_type
    ...
    Args:
        ...
        **kwargs: Additional keyword arguments passed to data_source_method
