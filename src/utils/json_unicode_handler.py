...
from src.utils.logging_config import ERROR_ICON, SUCCESS_ICON
...
def monkey_patch_all_agents():
    ...
    try:
        ...
        print(
            f"{SUCCESS_ICON} Successfully patched JSON serialization methods for all agent classes"
        )

    except ImportError as e:
        print(f"{ERROR_ICON} Failed to import agent modules: {e}")
        print(
            "Please ensure project structure is correct and run this script from project root directory"
        )
